"""
    Project :  Prime editing pilot screens. Revision experiment. Pre-processing script for endogenous MLH1 u1. Input are DIMSUM output dataframes containing variant counts. Output dataframes are: "*_data_full.csv".
    Date : 240905
    Python version 3.10
...
offset = 36993191  # used to translate amplicon position to GRCh38Location
