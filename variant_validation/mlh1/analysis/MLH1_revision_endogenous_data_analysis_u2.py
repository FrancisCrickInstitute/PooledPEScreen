"""
    Project :  Prime editing pilot screens. Revision experiment. Pre-processing script for endogenous MLH1 u2 data. Input are DIMSUM output dataframes containing variant counts. Output dataframes are: "*_data_full.csv". 
    Date : 240905
    Python version 3.10
...
def MLH1_endogenous_preprocessing(
    ...
    """
    Processing individual endogenous samples with dimsum variant count dataframes as input (D33 vs D19, D190 vs negative control).
