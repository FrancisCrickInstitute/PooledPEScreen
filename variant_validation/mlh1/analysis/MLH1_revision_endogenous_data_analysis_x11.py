"""
    Project :  Prime editing pilot screens. Revision experiment. Pre-processing script for endogenous MLH1 x10 data. Input are DIMSUM output dataframes containing variant counts. Output dataframes are: "x11_data_full.csv".
    Date : 240905
    Python version 3.10
