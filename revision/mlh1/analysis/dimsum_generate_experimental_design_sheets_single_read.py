"""
    Project :  Prime editing pilot screens. Revision experiment. Script to generate input txt files (experimental design sheets) for the dimsum pipeline (single read). 
    Date : 240906
    Python version 3.10
...
dimsum_map_path = "/camp/home/kajbac/home/shared/projects/PE/ScreeningData/240822_Revision/input/dimsum_map/CK_dimsum_map_single_read.csv"
...
for index, row in dimsum_map.iterrows():
    ...
    with open(output_file, "w") as f:
        ...
        # Write the 'input' row
        f.write(f"input\t1\t0\t\t\t{input_pair2}\t\n")

        # Write the 'output' row
        f.write(f"output\t1\t1\t1\t\t{output_pair2}\t\n")
